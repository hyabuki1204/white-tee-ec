        ...
        {article.body.map((paragraph, index) => {
          ...
          return (
            <div key={paragraph.slice(0, 32)} className="[&+&]:mt-8">
              <p className="text-[14px] font-light leading-[2] tracking-[0.02em] text-neutral-600 md:text-[14px] md:leading-[2.15]">
                {paragraph}
              </p>
              {paragraphJa ? (
                <p
                  lang="ja"
                  className="mt-4 text-[13px] font-extralight leading-[2.05] tracking-[0.03em] text-neutral-600 md:text-[13px] md:leading-[2.15]"
                >
                  {paragraphJa}
                </p>
              ) : null}
