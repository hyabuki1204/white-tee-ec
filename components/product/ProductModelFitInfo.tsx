  ...
  return (
    <>
      <div className="space-y-2">
        <p className="text-[12px] font-normal leading-[1.85] tracking-[0.04em] text-neutral-600 md:text-[12px]">
      ...
      <div className="space-y-3">
        <div className="space-y-1">
          <p className="text-[12px] font-normal uppercase tracking-[0.12em] text-neutral-600 md:text-[12px]">
            {fitProfile.fitLabel}
          </p>
          <p className="text-[12px] font-normal leading-[1.75] tracking-[0.03em] text-neutral-600 md:text-[12px]">
            {fitGlossary}
          </p>
        </div>
        ...
        <ul className="space-y-1.5">
          {fitProfile.sizeReference.map((band) => (
            <li
              key={band.size}
              className="flex gap-3 text-[12px] font-normal tracking-[0.04em] text-neutral-600 md:text-[12px]"
            >
          ...
          <ul className="space-y-1">
            {fitProfile.models.slice(1).map((model, index) => (
              <li
                ...
                className="text-[12px] font-normal tracking-[0.04em] text-neutral-600 md:text-[12px]"
              >
