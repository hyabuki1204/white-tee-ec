    ...
    <>
      ...
      <div className="space-y-3">
        <div className="space-y-1">
          <p className="text-[11px] font-light uppercase tracking-[0.12em] text-neutral-400 md:text-[10px]">
            {fitProfile.fitLabel}
          </p>
          <p className="text-[11px] font-light leading-[1.75] tracking-[0.03em] text-neutral-400 md:text-[10px]">
            {fitGlossary}
          </p>
        </div>
        ...
        <ul className="space-y-1.5">
          {fitProfile.sizeReference.map((band) => (
            <li
              key={band.size}
              className="flex gap-3 text-[11px] font-light tracking-[0.04em] text-neutral-500 md:text-[10px]"
            >
          ...
          <ul className="space-y-1">
            {fitProfile.models.slice(1).map((model, index) => (
              <li
                ...
                className="text-[11px] font-light tracking-[0.04em] text-neutral-500 md:text-[10px]"
              >
