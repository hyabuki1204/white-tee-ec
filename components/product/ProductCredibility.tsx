    ...
    >
      ...
      {wearingNote ? (
        <div>
          ...
          <p className="mt-3 text-[11px] font-normal tracking-[0.08em] text-neutral-600">
          ...
          <div className="mt-3 space-y-2">
            {wearingNote.lines.map((line) => (
              <p
                key={line}
                className="text-[11px] font-normal leading-[1.9] tracking-[0.04em] text-neutral-600"
              >
                {line}
              </p>
            ))}
      ...
      <div>
        ...
        <p className="mt-3 text-[11px] font-normal leading-[1.95] tracking-[0.04em] text-neutral-600">
          {PRICE_POSITIONING.intro}
        </p>
        <p className="mt-3 text-[11px] font-normal leading-[1.9] tracking-[0.04em] text-neutral-600">
          {PRICE_POSITIONING.care}
        </p>
        <Link
          href="/stockist"
          className="mt-4 inline-block text-[11px] font-normal tracking-[0.08em] text-neutral-600 transition-opacity hover:opacity-60"
        >
