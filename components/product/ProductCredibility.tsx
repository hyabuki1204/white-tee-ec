  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <div className="mt-3 space-y-2">
            {wearingNote.lines.map((line) => (
              <p
                key={line}
                className="text-[10px] font-light leading-[1.9] tracking-[0.04em] text-neutral-500"
              >
                {line}
              </p>
            ))}
      ...
      <div>
        ...
        <p className="mt-3 text-[10px] font-light leading-[1.95] tracking-[0.04em] text-neutral-500">
