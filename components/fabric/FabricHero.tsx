  ...
  return (
    <section aria-label={fabric.name} className="w-full">
      ...
      <div className="px-6 py-10 text-center sm:py-12 md:py-14">
        <h1 className="text-[14px] font-normal tracking-[0.2em] text-neutral-800 md:text-[14px]">
          {fabric.name}
        </h1>
        <p
          className={cn(
            "mx-auto mt-5 max-w-sm text-[14px] font-normal leading-[1.95] tracking-[0.02em] text-neutral-600 md:mt-6 md:text-[14px] md:leading-[2.05]",
