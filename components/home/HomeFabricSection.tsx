    ...
    <section aria-label="Fabric catalog" className="border-t border-neutral-200/70 pb-16 md:pb-24">
      <div className="mx-auto w-full max-w-7xl px-6 md:px-8 lg:px-12">
        <header className="flex items-end justify-between border-b border-neutral-200/70 py-8 md:py-10">
          <div>
            <h2 className="text-[14px] font-normal tracking-[0.28em] text-neutral-800">
              {GRAPHPAPER_STORE_COPY.home.sectionFabric}
            </h2>
            <p className="mt-3 text-[12px] font-normal tracking-[0.08em] text-neutral-600">
              {GRAPHPAPER_STORE_COPY.plp.items(fabrics.length)}
            </p>
          </div>
          <Link
            href="/fabric"
            className="hidden text-[12px] font-normal tracking-[0.08em] text-neutral-600 transition-opacity hover:opacity-60 sm:inline-block"
          >
