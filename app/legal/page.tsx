...
import { LEGAL_BUSINESS } from "@/lib/legal/content";

export const metadata: Metadata = {
  title: "Legal Notice | WHITE TEE",
  description: "特定商取引法に基づく表記",
};

export default function LegalPage() {
  const rows = [
    { label: "販売業者", value: LEGAL_BUSINESS.operator },
    { label: "所在地", value: LEGAL_BUSINESS.address },
    { label: "連絡先", value: LEGAL_BUSINESS.email },
    { label: "電話番号", value: LEGAL_BUSINESS.phone },
